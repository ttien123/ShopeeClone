...
const Input = ({
    ...
    classNameEye = 'absolute top-[10px] right-[5px] h-5 w-5 cursor-pointer',
    ...rest
}: Props) => {
    const [openEye] = useState(false);
    ...
    return (
        <div className={className}>
            ...
            {/* đây là để bắt TH cần có con mắt để đổi giữa text và password */}
